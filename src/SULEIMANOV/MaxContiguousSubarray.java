...
public class MaxContiguousSubarray {
    ...
    public static void main(String[] args) {
        int[] aray = new int[]{-2, 1, -3, 4, -1, 2, 1, -5, 4};
        int maxContSubaray = maxContiguousSubarray(aray);
        System.out.println(maxContSubaray);
    }

    static int maxContiguousSubarray(int[] nums) {
      /*
